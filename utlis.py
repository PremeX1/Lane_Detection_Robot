...
def initializeTrackbars(intialTracbarVals):
    ...
    cv2.resizeWindow("Test", 360, 240)
    cv2.createTrackbar("WT", "Test", intialTracbarVals[0],50, nothing)
    cv2.createTrackbar("HT", "Test", intialTracbarVals[1], 100, nothing)
    cv2.createTrackbar("WB", "Test", intialTracbarVals[2], 50, nothing)
    cv2.createTrackbar("HB", "Test", intialTracbarVals[3], 100, nothing)



def valTrackbars():
    widthTop = cv2.getTrackbarPos("WT", "Test")
    heightTop = cv2.getTrackbarPos("HT", "Test")
    widthBottom = cv2.getTrackbarPos("WB", "Test")
    heightBottom = cv2.getTrackbarPos("HB", "Test")
